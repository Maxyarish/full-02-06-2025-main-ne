...
module.exports.getAllProducts = async (req, res, next) => {
  try {
    ...
    const total = await Product.countDocuments(req.filter);
...
module.exports.getProductSale = async (req, res, next) => {
  try {
...
module.exports.getFiltersData = async (req, res, next) => {
  try {
    ...
    res.status(200).send({ data: filtersData });
  } catch (error) {
    next(error);
  }
};
